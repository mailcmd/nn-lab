{application,nx,
             [{modules,['Elixir.Inspect.Nx.Batch',
                        ...
                        'Elixir.Nx.Block.AllClose',
                        'Elixir.Nx.Block.CumulativeMax',
                        'Elixir.Nx.Block.CumulativeMin',
                        'Elixir.Nx.Block.CumulativeProduct',
                        'Elixir.Nx.Block.CumulativeSum',
                        'Elixir.Nx.Block.FFT2','Elixir.Nx.Block.IFFT2',
                        'Elixir.Nx.Block.IRFFT',
                        'Elixir.Nx.Block.LinAlg.Cholesky',
                        'Elixir.Nx.Block.LinAlg.Determinant',
                        'Elixir.Nx.Block.LinAlg.Eigh',
                        'Elixir.Nx.Block.LinAlg.LU',
                        'Elixir.Nx.Block.LinAlg.QR',
                        'Elixir.Nx.Block.LinAlg.SVD',
                        'Elixir.Nx.Block.LinAlg.Solve',
                        'Elixir.Nx.Block.LogicalNot','Elixir.Nx.Block.Phase',
                        'Elixir.Nx.Block.RFFT','Elixir.Nx.Block.Take',
                        'Elixir.Nx.Block.TakeAlongAxis',
                        'Elixir.Nx.Block.TopK','Elixir.Nx.Constants',
                        'Elixir.Nx.Container','Elixir.Nx.Container.Any',
                        ...
                        'Elixir.Nx.Floating','Elixir.Nx.Heatmap',
                        ...
                        'Elixir.Nx.LinAlg.SVD','Elixir.Nx.Mesh',
                        'Elixir.Nx.Pointer','Elixir.Nx.Random',
                        'Elixir.Nx.Ryu','Elixir.Nx.Serving',
